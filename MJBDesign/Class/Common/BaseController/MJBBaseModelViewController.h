...
@interface MJBBaseModelViewController : MJBBaseViewController

@property (strong, nonatomic)NSString *returnClassName;
//数据源
...
//网络请求方式(GET,POST)
@property (assign, nonatomic)MJBRequestMethod requestWay;
