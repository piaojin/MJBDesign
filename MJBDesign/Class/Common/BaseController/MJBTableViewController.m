...
- (void)setDataSource:(id <MJBBaseTableViewDataSource>)dataSource{
    if(dataSource){
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    id <MJBBaseTableViewDataSource> dataSource = (id <MJBBaseTableViewDataSource>) tableView.dataSource;
...
- (void)initFreshView{
    ...
    self.freshHeader.stateLabel.font = [UIFont systemFontOfSizeAndSetStyle:12.0];
    self.freshHeader.stateLabel.textColor = RGBCOLOR(178, 178, 178);
